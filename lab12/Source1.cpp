...
int main(int argc, char* argv[]) {
	...
	hMapFile = CreateFileMapping(file, NULL, PAGE_READONLY, 0, 0, NULL);
	if (hMapFile == INVALID_HANDLE_VALUE) printf("Could not mapping file\n");
	else printf("File has been mapped\n");

	fileData = (PBYTE)MapViewOfFile(hMapFile, FILE_MAP_READ, 0, 0, 0);
